...
class MainWindow(tk.Tk):
    def __init__(self):
        ...
        port_1_label = self.myCanvas.create_text(495,360, text="Port 1")
        port_2_label = self.myCanvas.create_text(495,390, text="Port 2")
        port_3_label = self.myCanvas.create_text(495,420, text="Port 3")
